...
export function LoginPage(): ReactNode {
  ...
  const newTokenUrl = CONFIG.repoOwner && CONFIG.repoName
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 rounded-md bg-slate-50 px-4 py-3 text-xs text-slate-600">
          <p className="mb-2 font-medium text-slate-700">Как получить токен?</p>
          <ol className="ml-4 list-decimal space-y-1">
            <li>
              ...
              >
                страницу создания PAT <ExternalLink size={11} />
              </a>
            </li>
            <li>Resource owner: ваш аккаунт; Repository access: только этот репо.</li>
            <li>
              Permissions: <code>Contents: Read &amp; write</code>,{' '}
              <code>Actions: Read &amp; write</code>, <code>Metadata: Read</code>.
            </li>
            <li>Скопируйте токен и вставьте сюда. Он сохранится только в этом браузере.</li>
          </ol>
        </div>
      </div>
    </div>
